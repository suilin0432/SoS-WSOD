...
from .pascal_voc import register_pascal_voc, register_pascal_voc_wsl
...
COCO_WSL = {
    "coco_2014_train_wsl": ("coco/train2014", "coco/annotations/train2014_wsl.json"),
    "coco_2014_valminusminival_wsl": ("coco/val2014", "coco/annotations/valminusminival2014_wsl.json"),
}
...
def register_all_pascal_voc(root):
    SPLITS = [
        ...
        ("voc_2012_test", "VOC2012_test", "test")
    ]
...
def register_all_pascal_voc_wsl(root):
    SPLITS = [
        ...
        ("voc_2012_train_wsl", "VOC2012", "train"),
        ("voc_2012_val_wsl", "VOC2012", "val")
    ]
    for name, dirname, split in SPLITS:
        year = 2007 if "2007" in name else 2012
