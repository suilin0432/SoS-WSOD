...
class PascalVOCDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        result_save_path_template = "/home/suil/codes/voc12result_ssod/VOC2012/Main/comp4_det_test_{}.txt"
        ...
        with tempfile.TemporaryDirectory(prefix="pascal_voc_eval_") as dirname:
            ...
            for cls_id, cls_name in enumerate(self._class_names):
                ...
                if os.path.isdir("/home/suil/codes/voc12result_ssod/") and "voc_2012_test" in self._dataset_name:
